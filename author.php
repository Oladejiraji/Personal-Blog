        ...
        <div id="nav-bar">
            <nav>
                <ul>
                    ...
                    <li class="current"><a href="author.php">Author</a></li>
        ...
        <div class="main-wrap">
            ...
            <div id="author">
                ...
                <?php
                    ...
                    echo "<div id='author-name'>".$row['profilename']."</div>";
                    echo "<div id='author-occ'>".$row['profileocc']."</div>";
                    echo "<div id='author-quote'>".$row['profilequote']."</div>";
                ?>
                    <div id="author-soc">
